...
| customize-opencode | Edit opencode's own configuration (opencode.json, config files, agents, skills) | When editing opencode config or creating opencode agents/skills/plugins |
...
| judgment-day | Parallel adversarial review protocol | When user says "judgment day", "judgment-day", "review adversarial", "dual review", "doble review", "juzgar", "que lo juzguen" |
...
| skill-registry | Create or update the skill registry for the current project | When user says "update skills", "skill registry", "actualizar skills", "update registry" |
...
| File | Type |
|------|------|
| guidelines/Guidelines.md | AI guidelines (Framework-generated template — mostly empty) |
